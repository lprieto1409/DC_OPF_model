...
M2S_TUE_2ft = M2S_TUE_dfs[2]
M2S_TUE_2ft['TUE_MWh'] = M2S_TUE_2ft['UE: No flood - 2ft'] + M2S_TUE_2ft['IUE_MWh']

M2S_TUE_8ft = M2S_TUE_dfs[8]
M2S_TUE_8ft['TUE_MWh'] = M2S_TUE_8ft['UE: No flood - 8ft'] + M2S_TUE_8ft['IUE_MWh']
...
M2S_TUE = M2S_TUE_8ft.loc[(M2S_TUE_8ft['Time']==Captures[j])&(M2S_TUE_8ft['TUE_MWh']>0)]
...
#Captures in time
M2S_TUE = M2S_TUE_8ft.loc[(M2S_TUE_8ft['Time']==Captures[j+1])&(M2S_TUE_8ft['TUE_MWh']>0)]
...
M2S_TUE = M2S_TUE_8ft.loc[(M2S_TUE_8ft['Time']==Captures[j+2])&(M2S_TUE_8ft['TUE_MWh']>0)]
...
#Captures in time
M2S_TUE = M2S_TUE_8ft.loc[(M2S_TUE_8ft['Time']==Captures[j+3])&(M2S_TUE_8ft['TUE_MWh']>0)]
...
# Captures in time
LMPs_sp = M2S_duals_during[i].loc[(M2S_duals_during[i]['Time']==Captures[j])]
...
#Captures in time
LMPs_sp = M2S_duals_during[i].loc[(M2S_duals_during[i]['Time']==Captures[j+1])]
...
#Captures in time
LMPs_sp = M2S_duals_during[i].loc[(M2S_duals_during[i]['Time']==Captures[j+2])]
...
#Captures in time
LMPs_sp = M2S_duals_during[i].loc[(M2S_duals_during[i]['Time']==Captures[j+3])]
...
fig.tight_layout()
plt.savefig(folder_images+'M2S_LMPs_Slack'+Depth[i]+'_v3.png', dpi=150, bbox_inches='tight')
plt.show()
plt.clf()