...
# Buble plot
scatt = ax.scatter(TUE_2ft_fig['centroid_x'], TUE_2ft_fig['centroid_y'], s=TUE_2ft_fig['DUE_MWh']*70 ,transform = ccrs.PlateCarree(),color = 'black', marker = 'o',edgecolors= 'black')

# Create legend manually
marker_sizes = [TUE_2ft_fig['TUE_MWh'].mean()*1.1, TUE_2ft_fig['TUE_MWh'].mean()*0.6, TUE_2ft_fig['TUE_MWh'].mean()*0.2]
legend_labels = ['568 MWh', ' ', '2 MWh']
...
# Buble plot
scatt = ax.scatter(TUE_8ft_fig['centroid_x'], TUE_8ft_fig['centroid_y'], s=TUE_8ft_fig['DUE_MWh']*70 ,transform = ccrs.PlateCarree(),color = 'black', marker = 'o',edgecolors= 'black')
...
# Buble plot
scatt = ax.scatter(TUE_2ft_fig['centroid_x'], TUE_2ft_fig['centroid_y'], s=TUE_2ft_fig['IUE_MWh']*70 ,transform = ccrs.PlateCarree(),color = 'green', marker = 'o',edgecolors= 'black')
...
# Buble plot
scatt = ax.scatter(TUE_8ft_fig['centroid_x'], TUE_8ft_fig['centroid_y'], s=TUE_8ft_fig['IUE_MWh']*70 ,transform = ccrs.PlateCarree(),color = 'green', marker = 'o',edgecolors= 'black')
...
plt.savefig(folder_images+'SUPP_DUE_IUE_communities.png', dpi=150, bbox_inches='tight')
plt.show()
plt.clf()
