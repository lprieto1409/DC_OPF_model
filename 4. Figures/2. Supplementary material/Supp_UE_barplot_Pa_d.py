...
#fig.suptitle("Date: "+Time[0], x=0.5, y=0.92, fontsize=font_title, fontweight='bold', ha='center', family='Arial')
...
for tt, ax in enumerate(axs.flat):
    ...
    if tt == 11:
        ...
        #Plot races - SLACK
        ax.bar(Race_abr[0], m2s_percen_d[tt]['% Indirect'][0], color = 'turquoise') #American Indian
        ax.bar(Race_abr[1], m2s_percen_d[tt]['% Indirect'][1], color = 'turquoise') #Asian
        ax.bar(Race_abr[2], m2s_percen_d[tt]['% Indirect'][2], color = 'turquoise') #Black
        ax.bar(Race_abr[3], m2s_percen_d[tt]['% Indirect'][3], color = 'turquoise') #Native Hawaiian
        ax.bar(Race_abr[4], m2s_percen_d[tt]['% Indirect'][4], color = 'turquoise') #Some other race
        ax.bar(Race_abr[5], m2s_percen_d[tt]['% Indirect'][5], color = 'turquoise') #Two or more
        ax.bar(Race_abr[6], m2s_percen_d[tt]['% Indirect'][6], color = 'turquoise') #White

        #Plot races - SUBSTATION LEVEL
        ax.bar(Race_abr[0], m2s_percen_d[tt]['% Direct'][0], bottom = m2s_percen_d[tt]['% Indirect'][0],color = 'gray') #American Indian
        ax.bar(Race_abr[1], m2s_percen_d[tt]['% Direct'][1], bottom = m2s_percen_d[tt]['% Indirect'][1],color = 'gray') #Asian
        ax.bar(Race_abr[2], m2s_percen_d[tt]['% Direct'][2], bottom = m2s_percen_d[tt]['% Indirect'][2],color = 'gray') #Black
        ax.bar(Race_abr[3], m2s_percen_d[tt]['% Direct'][3], bottom = m2s_percen_d[tt]['% Indirect'][3],color = 'gray') #Native Hawaiian
        ax.bar(Race_abr[4], m2s_percen_d[tt]['% Direct'][4], bottom = m2s_percen_d[tt]['% Indirect'][4],color = 'gray') #Some other race
        ax.bar(Race_abr[5], m2s_percen_d[tt]['% Direct'][5], bottom = m2s_percen_d[tt]['% Indirect'][5],color = 'gray') #Two or more
        ax.bar(Race_abr[6], m2s_percen_d[tt]['% Direct'][6], bottom = m2s_percen_d[tt]['% Indirect'][6],color = 'gray') #White
        ...
        ax2.plot(ax.get_xticks(), m2s_percen_d[tt]['Total Unserved'].values, linestyle='--', marker='o', color='black',
...
# Show the plot
plt.tight_layout()
plt.savefig(folder_images+'Supp_barplot_d.png', dpi=150, bbox_inches='tight')
plt.show()
